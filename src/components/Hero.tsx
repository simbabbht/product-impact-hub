...
export function Hero() {
  return (
    <section 
      id="hero" 
      className="min-h-[85vh] flex items-center justify-center section pt-[120px]"
    >
      <div className="container-custom text-center">
        {/* Main heading */}
        <h1 className="text-h1 mb-4 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          Product Owner — du cadrage à la livraison,{' '}
          <span className="gradient-text">avec impact.</span>
        </h1>
        ...
        >
          4–5 ans en grand groupe (Allianz) sur un espace client à forte audience. 
          J'aide les équipes à construire des parcours simples, prioriser efficacement et livrer proprement.
        </p>
